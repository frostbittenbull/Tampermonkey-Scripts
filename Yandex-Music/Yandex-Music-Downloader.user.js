...
// @version      18.14
// @updateURL    https://raw.githubusercontent.com/frostbittenbull/TamperMonkey-Scripts/main/Yandex-Music/Yandex-Music-Downloader.user.js
// @downloadURL  https://raw.githubusercontent.com/frostbittenbull/TamperMonkey-Scripts/main/Yandex-Music/Yandex-Music-Downloader.user.js
...
(function () {
    ...
    async function downloadCoverFile(url, filename) {
        try {
            ...
            if (!res.ok) { console.warn('[YMD] Cover fetch', res.status, url); return; }
                ...
                try {
                    ...
                    if ((isMP3 || isM4A) && downloadCovers) {
                        ...
                        try {
                            ...
                            if (coverUrl) {
                                const r = await fetch(coverUrl, { credentials: 'omit' });
                                if (r.ok) coverBuf = await r.arrayBuffer();
                            }
                        } catch(_) {}
